...
public class UnitMovement : MonoBehaviour
{
    ...
    public int MovementPoints, AttackRange, MaxHealth = 100, CurrentHealth = 100, AttackStat = 2, DefenceStat = 1;
    ...
    {
        if (MonsterId == 0 || MonsterId == 1 || MonsterId == 3) PosOffset = new Vector3(0, 2.5f, 0);
    ...
    public virtual void SetMyColor() {
        switch (MyState)
        {
            case UnitState.Ready:
                ...
                if (MonsterId == 0 || MonsterId == 1 || MonsterId == 3) MyBody.GetComponent<SkinnedMeshRenderer>().material.color = new Color32(255, 255, 255, 255);
                SetTileOccupy(true, false);
                break;
            ...
            case UnitState.Done:
                ...
                if (MonsterId == 0 || MonsterId == 1 || MonsterId == 3) MyBody.GetComponent<SkinnedMeshRenderer>().material.color = new Color32(120, 120, 120, 255);
    ...
    public virtual void TakeDamage(int Amount, float ElementApplify)
    {
        if (!MarkedForDeath)
        {
            ...
            //HealthBar.GetComponent<RectTransform>().sizeDelta = new Vector2(Percentage * 1000, 200);
            //HealthBarCanvas.transform.Find("Front").GetComponent<Image>().fillAmount = Percentage;
            HealthScript.SetPos(PositionTile.transform.position + new Vector3(-2f, 7f, -2f));
